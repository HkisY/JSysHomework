...
<div class="container">
    <div class="row clearfix">
        <table class="table table-hover table-striped">
            ...
            <tbody>
            <c:forEach var="postgraduate" items="${list}">
                <tr>
                    <td>${postgraduate.studentId}</td>
                    <td>${postgraduate.name}</td>
                    <td>${postgraduate.gender}</td>
                    <td>${postgraduate.grade}</td>
                    <td>${postgraduate.birthday}</td>
                    <td>${postgraduate.major}</td>
                    <td>${postgraduate.tutor}</td>
